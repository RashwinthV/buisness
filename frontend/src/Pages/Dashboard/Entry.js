  ...
  return (
    <div className="container py-4">
      ...
      <div className="text-center mb-4 d-flex gap-3 justify-content-center flex-wrap">
        <button className="btn btn-outline-primary" onClick={() => openModal("sales")}>
          + Sales Entry
        </button>
        <button className="btn btn-outline-success" onClick={() => openModal("purchase")}>
          + Purchase Entry
        </button>
      </div>
          ...
          {form.products.map((p, idx) => (
            <div className="row g-2 align-items-center mb-2" key={idx}>
              ...
              <div className="col-2 text-end">
                <button className="btn btn-sm btn-danger" onClick={() => removeProduct(idx)}>
                  ×
                </button>
              </div>
            </div>
          ))}
          <button className="btn btn-sm btn-outline-secondary mt-2" onClick={addProduct}>
            + Add Product
          </button>
        </div>
