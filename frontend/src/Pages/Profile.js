...
//       fetch(`${baseUrl}/v3/userimage/deleteimage/${user?.id}`, {
//         method: "POST",
//         headers: {
...
//       })
//         .then(() => console.log("Auto-deleted profile image on unmount."))
//         .catch((err) => console.error("Auto-delete failed:", err));
//     }
//   };
// }, [userData.profilepic, user, token, baseUrl]);
