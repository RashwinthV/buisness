...
import ProtectedBusiness from "../context/ProtectedBusinessRoute";
import Layout from "../components/Layout/Layout";
import AccountStatusTab from "../Pages/User/Settings/Tabs/accountTab";
import BusinessTab from "../Pages/User/Settings/Tabs/businessTab";
import SettingsTabs from "../Pages/User/Settings/Settings";
import GeneralTab from "../Pages/User/Settings/Tabs/Gendral";
    ...
    children: [
      ...
      { path: "viewbusinessprofile/:businessId", element: <BusinessProfile /> },
      {
        ...
        children: [
          ...
          { path: "business", element: <BusinessTab /> },
          { path: "account", element: <AccountStatusTab /> },
          { index: true, element: <GeneralTab /> }, // Optional default tab
        ],
      },
    ],
  },
